...
from tee import enclave_server_pb2 as tee_dot_enclave__server__pb2
...
class EnclaveServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.InitEnclave = channel.unary_unary(
                ...
                request_serializer=tee_dot_enclave__server__pb2.InitEnclaveRequest.SerializeToString,
                response_deserializer=tee_dot_enclave__server__pb2.InitEnclaveResponse.FromString,
                )
        self.DeployContract = channel.unary_unary(
                '/tee.EnclaveServer/DeployContract',
                request_serializer=common_dot_request__pb2.TxRequest.SerializeToString,
                response_deserializer=tee_dot_enclave__server__pb2.EnclaveResponse.FromString,
                )
        ...
        self.RemoteAttestationProve = channel.unary_unary(
                ...
                request_serializer=tee_dot_enclave__server__pb2.RemoteAttestationRequest.SerializeToString,
                response_deserializer=tee_dot_enclave__server__pb2.RemoteAttestationResponse.FromString,
                )
...
def add_EnclaveServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'InitEnclave': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=tee_dot_enclave__server__pb2.InitEnclaveRequest.FromString,
                    response_serializer=tee_dot_enclave__server__pb2.InitEnclaveResponse.SerializeToString,
            ),
            'DeployContract': grpc.unary_unary_rpc_method_handler(
                    servicer.DeployContract,
                    request_deserializer=common_dot_request__pb2.TxRequest.FromString,
                    response_serializer=tee_dot_enclave__server__pb2.EnclaveResponse.SerializeToString,
            ),
            ...
            'RemoteAttestationProve': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=tee_dot_enclave__server__pb2.RemoteAttestationRequest.FromString,
                    response_serializer=tee_dot_enclave__server__pb2.RemoteAttestationResponse.SerializeToString,
            ),
    }
...
class EnclaveServer(object):
    ...
    def InitEnclave(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/tee.EnclaveServer/InitEnclave',
            tee_dot_enclave__server__pb2.InitEnclaveRequest.SerializeToString,
            tee_dot_enclave__server__pb2.InitEnclaveResponse.FromString,
    ...
    def DeployContract(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/tee.EnclaveServer/DeployContract',
            common_dot_request__pb2.TxRequest.SerializeToString,
            tee_dot_enclave__server__pb2.EnclaveResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def RemoteAttestationProve(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/tee.EnclaveServer/RemoteAttestationProve',
            tee_dot_enclave__server__pb2.RemoteAttestationRequest.SerializeToString,
            tee_dot_enclave__server__pb2.RemoteAttestationResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
